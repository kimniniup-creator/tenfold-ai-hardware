...
参见[硬件模型、全范围干涉、尺寸链和工具路径](HARDWARE_VALIDATION.md)。24件硬件含四角螺母/垫圈；只验证附件，整机仍BLOCKED。
...
| M3×32螺钉 | 4 | 从底压条穿角柱到顶盖；全牙，27mm打印夹层+0.5mm垫圈+3mm螺母，名义露出1.5mm（3牙） |
| M3螺母、指定尺寸垫圈 | 各8 | 螺母高≤3mm/外接径≤6.4mm；夹爪垫圈OD9、四角OD6，均ID≥3.4/厚0.5mm；见尺寸链 |
