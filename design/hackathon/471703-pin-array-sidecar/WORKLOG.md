...
2026-09-22 independent test fixes: increased clamp fastener pitch 5→11 mm, widened flange/clamps, explicit M3 bolt/nut/washer/tool envelopes, hardware-inclusive STEP and all-pair/tool/closure checks. Added grip-trial schematic and actionable physical trial. Reviewed rendered hardware assembly and grip schematic. Original source remains unavailable; no claim of full adaptation or print testing.
