...
2026-09-22 用户确认新方向：M5Stick本机原生按键把玩、节奏摘要给Agent、原创老像素宠物在本机屏幕陪伴。不制作外壳，不要求十日任务。以[新PRD](docs/hackathon/product/PIXEL_COMPANION_PRD.md)为本轮权威；固件、软件桥接和实板测试正在实施。

以下为已发布的旧版十日环历史设计与交付，不作为新方向实现要求。

Tenfold 是一枚把长期项目压缩成十日承诺的 AI EDC。AI 负责收集、去重和减法，机械盘负责把“回来、完成、停下”变成可触摸的动作。

> 当前黑客松交付：三版原创机械 EDC 数字试打包、经过模拟器运行验收的 Android APK，以及编译通过的 M5StickS3 单周期固件。真实手机/板卡通信和实物打印尚未验证；先按校准件与装配说明试打。
