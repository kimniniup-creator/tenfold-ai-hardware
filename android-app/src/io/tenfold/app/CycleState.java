...
final class CycleState {
  ...
  private String statusLabel(String status){if(status.isEmpty())return "无记录";if("COMPLETED_SEALED".equals(status))return "已完成并封存";if("SEALED_UNFINISHED".equals(status))return "未完成，已封存";if("COMPLETED".equals(status))return "已完成";return "已记录";}
