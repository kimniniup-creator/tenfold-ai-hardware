param([string]$Revision='0daf340988157b66cca29403c9e7492975b4533f')
...
& javac -encoding UTF-8 -d $scratch (Join-Path $PSScriptRoot 'android/content/SharedPreferences.java') (Join-Path $scratch 'CycleState.java') (Join-Path $PSScriptRoot 'io/tenfold/app/StateProbe.java')
if($LASTEXITCODE -ne 0){throw 'Probe compilation failed'}
"SOURCE_REVISION=$Revision"
& java -cp $scratch io.tenfold.app.StateProbe
