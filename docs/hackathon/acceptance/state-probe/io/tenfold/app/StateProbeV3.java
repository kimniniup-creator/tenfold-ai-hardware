...
public class StateProbeV3 {
  ...
  public static void main(String[] args){
    ...
    report("U10_DAILY_FACTS",!summary.contains("SEALED_UNFINISHED")||!summary.contains("COMPLETED")||!summary.contains("B"),"D1 unfinished and D2 completed remain separate");
    ...
    report("U10_DEMO_HISTORY_IN_REAL",c.reviewSummary().contains("COMPLETED"),"startReal resets identity but retains demo day records");
  }
}
