...
2026-09-22最终收口：O1三原创数字试打PASS、O2 B960手机模拟PASS_SCOPED、O3/O4 NOT_TESTED。锁机械独测00d5e76、APK独测c6f044b、PM最终a8cd787；22真实CycleState反例全关。固件0e7b044 R05 completed_day diff及ZIP394376/appFB0EB/factoryD89B哈希已独立核对，编译成功引用作者实际构建回执；明确仅单周期，不扩整机声明。当前报告首部已重写，以首部最终门表为准。
