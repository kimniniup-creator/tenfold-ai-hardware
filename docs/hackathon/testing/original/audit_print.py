...
cfg=root/'docs/hackathon/testing/original/generic-pla.ini'
report={'sha':sha,'path':a.path,'slicer':'PrusaSlicer 2.9.6','profile_sha256':hashlib.sha256(cfg.read_bytes()).hexdigest(),'supports_enabled':a.support,'physical_print_tested':False,'parts':{}}
def parse_gcode(f):
